<x-app-layout>
    ...
    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" type="file" id="formFile">
      ...
      "
            ...
            <div class="flex justify-center">
                <button type="submit"
                        class="mx-1 px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded
                ...
                <a href="{{ url()->previous() }}" class=" px-6 py-2.5 bg-red-600 text-white font-medium text-xs leading-tight uppercase rounded
                    shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none
                    focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Cancel</a>
            </div>
        </form>
    </div>
</x-app-layout>
